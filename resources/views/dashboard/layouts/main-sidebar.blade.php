    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <!-- Project Name in List Item -->

                <ul class="list-unstyled project-name-list mt-3">
                    <li>
                        {{ __('Dashboard/main_sidebar_trans.name_of_proj') }}
                    </li>
                </ul>
            </div>
        ...
        <ul class="side-menu">
            ...
            {{-- <li class="side-item side-item-category">{{ __('Dashboard/main_sidebar_trans.main') }}</li> --}}

            <li class="side-item side-item-category">{{ __('Dashboard/main_sidebar_trans.General') }}</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ __('Dashboard/main_sidebar_trans.sections') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('sections.index') }}">{{ __('Dashboard/main_sidebar_trans.show_all') }}</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ __('Dashboard/main_sidebar_trans.doctors') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('doctors.index') }}">{{ __('Dashboard/main_sidebar_trans.show_all') }}</a>
                    </li>
